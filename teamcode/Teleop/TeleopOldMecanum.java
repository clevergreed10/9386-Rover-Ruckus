...
@TeleOp(name="Teleop: Mecanum Drive Old Version", group="Robot")
@Disabled
public class TeleopOldMecanum extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad1.right_bumper){
            robot.wheel1.setPower(1);
            robot.wheel2.setPower(0);
            robot.wheel3.setPower(0);
            robot.wheel4.setPower(1);
        }
        else if (gamepad1.right_bumper){
            robot.wheel1.setPower(0);
            robot.wheel2.setPower(1);
            robot.wheel3.setPower(1);
            robot.wheel4.setPower(0);
        }
        else{
