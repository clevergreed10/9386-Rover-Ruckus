...
public class AutoCraterJr extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       // gyroHold(0.5);
        ...
        gyroDrive(0, DRIVE_SPEED, 3.0, 1.0);
        ...
        gyroDrive(133, -DRIVE_SPEED, 22, 4.0);
        bot.pusher.setPosition(0.5);
        detector.enable();
        gyroStrafe(1.0, 0, 5, 1.0);
        bot.liftMotor.setPower(1);
        gyroDrive(90, -DRIVE_SPEED, 22, 4.0);
        bot.liftMotor.setPower(0);
        gyroStrafe(1.0, 0, 5, 1.0);
        gyroDrive(0, 1, 10.5, 1.0);
        gyroDrive(0, -1, 2, 1.0);
        gyroStrafe(1, 1, 2, 1.0);

        gyroHold(1.0); // give the camera some time
        ...
        if (goldSide == 0) { // RIGHT
            gyroDrive(180, -1.0, 2,1.0);
            gyroStrafe(1.0, 0, 10, 2.0);
            gyroDrive(180 , -1.0, 10, 2.0);
            gyroHold(1.0);
            //gyroDrive(-135, 0.5, 8, 2.0);
        } else if (goldSide == 1) { // LEFT
            gyroDrive(180, -1.0, 2,1.0);
            gyroStrafe(1.0, 1, 8, 2.0);
            gyroDrive(-170, -1.0, 10, 2.0);
            gyroHold(1.0);
            //gyroDrive(0, -0.5, 7, 2.0);
        } else if (goldSide == 2) { // CENTER
            gyroStrafe(1.0, 0, 2, 1.0);
            gyroDrive(179, -1.0, 12, 2.0);
            gyroHold(1.0);
