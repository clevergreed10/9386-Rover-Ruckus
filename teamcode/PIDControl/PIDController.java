...
public class PIDController {
    ...
    private double minOutput   = -PLACEHOLDER;
    private double maxOutput   = PLACEHOLDER;
    ...
    public double calculate(double error) {
        ...
        if (this.oldTime == 0) {
            ...
            this.integral = Range.clip(this.integral + error * deltaT, this.minIntegral, this.maxIntegral);
            this.derivative = (error - this.oldError)/deltaT; // change in Y / change in X
        } else { // this may present problems... idk
            this.integral = 0;
            this.derivative = 0;
        }
